...
template <typename T>
void loadInputRow(std::ifstream& input, std::string& name, T*& data, int& nbWeights, Dims& d)
{
    int32_t type;
    int32_t nbDims;
    int32_t dim;
...
//sds: input file must be beishu of 3, first is input_id /input_mask/ segment_id
