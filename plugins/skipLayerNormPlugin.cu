...
thread_local PluginFieldCollection SkipLayerNormPluginDynamicCreator::mFC{};
thread_local std::vector<PluginField> SkipLayerNormPluginDynamicCreator::mPluginAttributes;
