...
#define NULL_LENGTH				(~0ULL)

#define SQLSTATE_LENGTH			5
#define SQLSTATE_DEFAULT		"HY000"
#define NUM_STR_LENGTH			9
#define FLOAT_STR_LENGTH		8 // 7 for float
#define DOUBLE_STR_LENGTH		20 // 19 for long double
