...
enum
{
	HTTP_SYSTEM_ERROR = -1001,
	HTTP_DNS_ERROR = -1002,
	HTTP_CONNECTION_CLOSED = -1003,
	HTTP_SSL_ERROR = -1004,
	HTTP_PARSE_URI_FAILED = -1005,
	HTTP_REDIRECT_FAILED = -1006
};
...
using ON_SUCCESS = std::function<void (HttpResponse&)>;
...
/*
	...
	//async future
	std::future<WFHttpResult> future_request(const std::string& method,
											 const std::string& url,
											 const std::map<std::string, std::string>& headers,
											 const std::string& body);
*/
