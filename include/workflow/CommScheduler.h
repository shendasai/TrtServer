...
public:
	int init(const struct sockaddr *addr, socklen_t addrlen,
			 size_t max_connections, int connect_timeout,
...
public:
	int init(const struct sockaddr *addr, socklen_t addrlen,
			 size_t max_connections, int connect_timeout,
			 int response_timeout, SSL_CTX *ssl_ctx,
			 int ssl_connect_timeout)
	{
		int ret = this->init(addr, addrlen, max_connections, connect_timeout,
							 response_timeout);
...
public:
	...
	{
		return this->comm.drain(max, service);
	}
